...
#include "SCOSCClientManager.h"

#include "OSCClient.h"
#include "OSCMessage.h"
#include "OSCManager.h"

void USCOSCClientManager::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("OSC Client Manager initialized"));

}

void USCOSCClientManager::Deinitialize()
{// Destroy all OSC Clients
	...
	UE_LOG(LogTemp, Warning, TEXT("OSC Client Manager deinitialized"));
